"""
Django settings for coral_search_backend project.
...
SECRET_KEY = 'django-insecure-z8($$#=o2wc38oc1g%rilg&8u!m395x=p6ua+hhc85cnzdpjg)'
...
WSGI_APPLICATION = 'coral_search_backend.wsgi.application'
